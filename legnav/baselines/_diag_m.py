...
from legnav.baselines.pretrain_navrep import collect_expert_lidar, _encode_all, VM_CKPT
from legnav.baselines.navrep_network import Z_DIM

# load trained encoder
with open(VM_CKPT, "rb") as f:
    blob = f.read()
import legnav.baselines.navrep_network as nn_mod
