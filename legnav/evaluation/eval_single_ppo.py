...
def _parse():
    ...
    p.add_argument("--ckpt",      type=str,  default=paths.checkpoint("ppo", "ppo_tanh_fix_final.msgpack"))
...
def _build_ppo_act_vmap(ckpt_path, tanh_outside):
    from legnav.core.jax_network import EndToEndActorCritic
...
def main():
    ...
    # Estrae il nome del modello dal percorso (es. da paths.checkpoint("ppo", "ppo_attn_final.msgpack") prende "ppo_attn_final")
