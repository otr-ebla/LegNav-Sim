...
def _parse_args():
    ...
    p.add_argument("--ckpt",    default=paths.checkpoint("ppo", "ppo_model_best.msgpack"),
...
from legnav.core.jax_env import (reset_env, step_env,
                     ROOM_W, ROOM_H, ROBOT_RADIUS, PEOPLE_RADIUS,
                     NUM_RAYS, MAX_LIDAR_DIST, FOV, NUM_PEOPLE,
                     NUM_OBS_CIR, NUM_OBS_BOX, MAX_STEPS)
from legnav.core.jax_legs import get_leg_positions, LEG_RADIUS, HIP_WIDTH, SHOE_LENGTH, SHOE_WIDTH
