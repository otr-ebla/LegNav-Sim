...
from legnav.core.jax_env import ROOM_W, ROOM_H, ROBOT_RADIUS, PEOPLE_RADIUS, NUM_RAYS, MAX_LIDAR_DIST, FOV, MAX_STEPS
...
def main():
    print(f"\n🚀 DreamerV3 Eval")
    ckpt = paths.checkpoint("ppo", "dreamer_best.msgpack")
