...
from legnav.algorithms.jax_train import init_env_state, collect_rollouts, NUM_ENVS, ROLLOUT_STEPS, OBS_SIZE
from legnav.core.jax_scenarios import TEST_SCENARIO_NAMES
...
def main():
    ...
    parser.add_argument("--ckpt", type=str, default=paths.checkpoint("ppo", "ppo_tanh_fix_final.msgpack"), help="Percorso del checkpoint")
    ...
    out_file = paths.figure("tanh_test_action_distributions.png")
