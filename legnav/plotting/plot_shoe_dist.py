...
from legnav.evaluation.paper_comparison_eval import (
...
def main():
    ...
    ckpt = paths.checkpoint("ppo", "ppo_attn_final.msgpack")
    ...
    plt.savefig(paths.figure("shoe_distance_distribution.png"), dpi=300, bbox_inches='tight')
    print("\nSaved", paths.figure("shoe_distance_distribution.png"))
