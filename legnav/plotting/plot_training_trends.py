...
LOG_INSIDE = paths.checkpoint("ppo", "ppo_tanh_inside_log.csv")
LOG_OUTSIDE = paths.checkpoint("ppo", "ppo_tanh_outside_log.csv")
...
def main():
    ...
    fig1.tight_layout()
    fig1.savefig(paths.figure("trend_reward_comparison.png"), dpi=300)
    print("✅ Saved", paths.figure("trend_reward_comparison.png"))
    ...
    fig2.tight_layout()
    fig2.savefig(paths.figure("trend_logsigma_comparison.png"), dpi=300)
    print("✅ Saved", paths.figure("trend_logsigma_comparison.png"))
